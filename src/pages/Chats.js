...
const Chats = () => {
  ...
  return (
    <div>
      {!selectedChat && <PageTitle>Conéctate con tus clientes</PageTitle>}
      {selectedChat && (
        <div className="flex items-center mt-6">
          ...
          <Badge type={selectedChat.state === true ? "success" : "danger"}>
            {selectedChat.state === true ? "En línea" : "Ausente"}
          </Badge>
        </div>
      )}
        ...
        <div className="md:col-span-3 ">
          {!selectedChat ? (
            <div className="mt-32 flex flex-col justify-center items-center">
              <SelectChatWaiter />
              <p className="text-gray-600 dark:text-gray-400">Selecciona un chat</p>
            </div>
          ) : (
            <div>
